 ...
 *
 */
public class WriteMember extends Configured implements Tool {

	private static final Logger logger = LoggerFactory
			.getLogger(WriteMember.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(WriteMember.class);
	...
	public static class InnerMapper extends Mapper<Text, Text, Text, Text> {
		...
		protected void map(Text key, Text value, Context context)
			...
			if (val.length == 11) {
				...
				String inputString = "";
				inputString = "("+uid+",'"+username+"',0,'0000-00-00','',3,0,1453427494,2887392922,1453539021,1,1,1,'',0,0,0,0,115,0,0,0,0,0),";
				word.set(inputString);
				context.write(word, new Text());
				inputString = "("+suid+",'"+susername+"',0,'0000-00-00','',3,0,1453427494,2887392922,1453539021,1,1,1,'',0,0,0,0,115,0,0,0,0,0),";
				word.set(inputString);
				context.write(word, new Text());
			}
		}
