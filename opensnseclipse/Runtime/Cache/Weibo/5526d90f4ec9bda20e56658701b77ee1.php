        ...
        <div class="col-xs-12 weibo_content" style="padding: 0;position:relative;">
            ...
            <div class="" style="padding: 10px 10px 5px 10px">
                ...
                <div class="col-xs-10" style="padding: 5px">
                    ...
                    <span>
                        <a href="<?php echo U('Weibo/Index/weiboDetail1',array('id'=>$weibo['id']));?>"><?php echo (friendlydate($weibo["create_time"])); ?></a>
                    </span>
            ...
            <div class="col-xs-12 weibo_content_bottom">
                <div class="col-xs-12" style="padding: 0px;text-align: center" data-weibo-id="<?php echo ($weibo["id"]); ?>">
                    ...
                    <div class="col-xs-4"style="padding: 0px"><?php echo Hook('support',array('table'=>'weibo','row'=>$weibo['id'],'app'=>'Weibo','uid'=>$weibo['uid'],'jump'=>'weibo/index/weibodetail1'));?></div>

<?php $sourceId =$weibo['data']['sourceId']?$weibo['data']['sourceId']:$weibo['id']; ?>
<a title="<?php echo L('_REPOST_');?>"  data-role="send_repost"  href="<?php echo U('Weibo/Index/sendrepost1',array('sourceId'=>$sourceId,'weiboId'=>$weibo['id']));?>"><?php echo L('_REPOST_');?> <?php echo ($weibo["repost_count"]); ?></a>
