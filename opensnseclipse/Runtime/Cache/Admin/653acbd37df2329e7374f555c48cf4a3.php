...
<form id="searchForm" method="get" action="<?php echo ((isset($searchPostUrl) && ($searchPostUrl !== ""))?($searchPostUrl):'/opensnseclipse/index.php?s=/admin/weibo/topic.html'); ?>" class="form-dont-clear-url-param">
...
<?php if(count($searches) > 0): ?><button class="btn submit-btn" url="?status=-1" target-form="ids" style="padding: 6px 16px;" onclick="toggle_search()"><?php echo L("_SEARCH_");?></button><?php endif; ?>
            ...
            <div style="float: right;" >
                ...
                <form id="selectForm" method="get" action="<?php echo ((isset($selectPostUrl) && ($selectPostUrl !== ""))?($selectPostUrl):'/opensnseclipse/index.php?s=/admin/weibo/topic.html'); ?>" class="form-dont-clear-url-param">
