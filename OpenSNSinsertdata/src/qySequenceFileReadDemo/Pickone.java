 ...
 *
 */
public class Pickone extends Configured implements Tool {

	private static final Logger logger = LoggerFactory.getLogger(Pickone.class);
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new Pickone(), args));
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName("Pick one");
		job.setJarByClass(Pickone.class);
