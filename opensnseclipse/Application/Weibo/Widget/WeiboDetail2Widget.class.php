 ...
 * 用于动态调用分类信息
 */
class WeiboDetail2Widget extends Controller
{

    /* 显示指定分类的同级分类或子分类列表 */
    public function detail2($weibo_id,$can_hide=0)
    {
        ...
        $this->display(T('Weibo@Widget/detail2'));
    }
    ...
    public function weibo_html($weibo_id)
    {
        $weibo = D('Weibo/Weibo')->getWeiboDetail($weibo_id);
        $this->assign('weibo', $weibo);
        return $this->fetch(T('Application://Weibo@Widget/detail2'));
    }
}
