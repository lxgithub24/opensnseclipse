...
<div class="col-xs-6 lg_left">
    <div class="col-xs-12">
        <div class="col-xs-12  lg_lf_top">
            <h2><?php echo L('_WELCOME_TO_');?> <?php if(($login_type) == "login"): ?><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/opensnseclipse" title="L('_ENTER_INDEX_')"><?php echo modC('WEB_SITE_NAME',L('_OPEN_SNS_'),'Config');?></a><?php else: echo modC('WEB_SITE_NAME',L('_OPEN_SNS_'),'Config'); endif; ?> ！</h2>
        </div>
        <div class="clearfix"></div>
        <form action="/opensnseclipse/index.php?s=/ucenter/member/login.html" method="post" class="lg_lf_form ">
            <div class="row">
