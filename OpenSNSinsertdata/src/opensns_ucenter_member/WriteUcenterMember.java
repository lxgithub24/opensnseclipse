package opensns_ucenter_member;
 ...
 *
 */
public class WriteUcenterMember extends Configured implements Tool {

	private static final Logger logger = LoggerFactory
			.getLogger(WriteUcenterMember.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(WriteUcenterMember.class);
	...
	public static class InnerMapper extends Mapper<Text, Text, Text, Text> {
		...
		protected void map(Text key, Text value, Context context)
			...
			if (val.length == 11) {
				...
				String inputString = "";
//				(100, 'liuxiang1', '7801fd20748079808de740696d0849c9', '', '', 1453512556, 2130706433, 1453645661, 2130706433, 1453512556, 1, 1),
				inputString = "("+uid+",'"+username+"','7801fd20748079808de740696d0849c9','','',1453512556,2130706433,1453645661,2130706433,1453512556,1,1),";
				word.set(inputString);
				context.write(word, new Text());
				inputString = "("+suid+",'"+susername+"','7801fd20748079808de740696d0849c9','','',1453512556,2130706433,1453645661,2130706433,1453512556,1,1),";
				word.set(inputString);
				context.write(word, new Text());
			}
		}
