...
class Comment1Widget extends Controller
{
    ...
    public function someComment($weibo_id){
       ...
       $this->assign('comments', $comments);
        ...
        $this->assign('page',1);
       $this->display(T('Weibo@default/Widget/comment/somecomment1'));
    }
    ...
    public function someCommentHtml($weibo_id){
        ...
        $this->assign('weiboId',$weibo_id);
        $this->assign('page',1);
        return $this->fetch(T('Weibo@default/Widget/comment/somecomment1'));
    }
