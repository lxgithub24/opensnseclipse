...
<html lang="en" style="background: #4f8ad0">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/login.css" media="all">
        <!--zui-->
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><img class="logo" src="/opensnseclipse/Application/Admin/Static/images/login_logo.png"><?php echo L("_LANDING_BACKGROUND_");?></h3>
