            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <p class="pull-right">
                        <?php echo use_topic();?>
                        &nbsp;&nbsp;&nbsp;
                        <input type="submit" value="<?php echo L('_PUBLISH_');?>"  data-role="send_weibo" class="btn btn-primary btn-lg" style="border:none;width: 100px" data-url="<?php echo U('Weibo/Index/doSend1');?>"/>
                    </p>
                </div>
            </div>
...
<?php if(empty($lastId) == false): ?><script>
        ...
        >
        <p id="load_more_text"><img style="margin-top:80px" src="/opensnseclipse/Application/Weibo/Static/images/loading-new.gif"/></p>
    </div>
