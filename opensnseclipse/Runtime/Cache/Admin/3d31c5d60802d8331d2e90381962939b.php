...
<head>
    ...
    <link href="/opensnseclipse/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">


    <!--zui-->
    <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/zui/css/zui.css" media="all">
    <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/admin.css" media="all">
    <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/ext.css" media="all">
    <!--zui end-->

    <!--
        <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/base.css" media="all">
        <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/common.css" media="all"-->
    <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/module.css">
    <link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/style.css" media="all">
    <!--<link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">-->
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/opensnseclipse/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/opensnseclipse/Public/js/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "icon": ?><div class='icon-chose' title=<?php echo L("_SELECT_ICON_WITH_DOUBLE_");?> style="width: 400px;">
        ...
        <script src="/opensnseclipse/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/opensnseclipse/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
...
<script src="/opensnseclipse/Application/Admin/Static/zui/lib/chosen/chosen.js"></script>
<link href="/opensnseclipse/Application/Admin/Static/zui/lib/chosen/chosen.css" type="text/css" rel="stylesheet">
...
<script type="text/javascript" src="/opensnseclipse/Public/static/think.js"></script>

<!--zui-->
<script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/common.js"></script>
<script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/com/com.toast.class.js"></script>
<script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/zui/js/zui.js"></script>
<script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/zui/lib/migrate/migrate1.2.js"></script>
<!--zui end-->
<link rel="stylesheet" type="text/css" href="/opensnseclipse/Application/Admin/Static/js/kanban/kanban.css" media="all">
<script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/kanban/kanban.js"></script>
<script type="text/javascript">
    +function () {
    ...
    <?php if($importDatetimePicker): ?><link href="/opensnseclipse/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
    ...
    <link href="/opensnseclipse/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet">
