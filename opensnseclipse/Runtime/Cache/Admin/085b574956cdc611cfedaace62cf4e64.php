...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/opensnseclipse/Application/Admin/Static/js/highcharts.js"></script>
    ...
    <script>
        $('[data-role=saveCountSetting]').click(function () {
            $.post("/opensnseclipse/index.php?s=/admin/index/index.html", {count_day: $('[name=count_day]').val()}, function (msg) {
                handleAjax(msg);
            });
        })
    </script>
