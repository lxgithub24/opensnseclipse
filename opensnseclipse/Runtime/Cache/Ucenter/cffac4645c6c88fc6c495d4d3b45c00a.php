...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <link href="/opensnseclipse/Application/Ucenter/Static/css/center.css" type="text/css" rel="stylesheet">
    <section>
        <div class="col-xs-12 col-sm-offset-1 register clearfix" style="margin-top: 50px;margin-bottom: 110px;background-color: white;padding: 10px;">
            ...
            <?php if($step == 'start'): ?><div class="col-xs-6">
                    <form class="" action="/opensnseclipse/index.php?s=/ucenter/member/step/step/finish.html" method="post">
...
<script src="/opensnseclipse/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <link href="/opensnseclipse/Application/Core/Static/css/form_check.css" rel="stylesheet" type="text/css">
    <script src='/opensnseclipse/Application/Core/Static/js/form_check.js'></script>
    <script>
        // 验证密码长度
        $(function(){
